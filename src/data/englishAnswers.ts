...
function generateDayAnswers(day: number): IEnglishAnswerKey {
  ...
  const quizQuestions: IReadingQuizQuestion[] = [
    {
      question: `根据阅读文章，关于${theme}以下哪个说法是正确的？`,
      options: [
        `${theme}对大多数人来说不重要`,
        `${theme}需要长期坚持和练习`,
        `${theme}只有专业人士才需要`,
      ...
      correctIndex: 1,
      explanation: "文章强调了任何技能或习惯都需要时间和持续的努力，不是一蹴而就的。",
    },
    {
      question: `文章中提到的关于${theme}的建议是什么？`,
      options: [
        "尽可能快地完成",
        "从小处开始，逐步建立习惯",
        "只在有时间的时候做",
      ...
      correctIndex: 1,
      explanation: "文章建议从简单的小步骤开始，建立可持续的习惯，而不是追求速成。",
    },
    {
      question: `根据文章，${theme}中最常见的错误是什么？`,
      options: [
        "太有耐心",
        "期望立竿见影，放弃得太早",
        "练习得太多",
      ...
      correctIndex: 1,
      explanation: "很多人因为看不到即时效果而过早放弃，文章强调坚持的重要性。",
    },
  ];
...
for (let i = 1; i <= 30; i++) {
  MOCK_ENGLISH_ANSWERS[i] = generateDayAnswers(i);
}
...
MOCK_ENGLISH_ANSWERS[1] = {
  ...
  readingQuiz: [
    {
      question: "What time does Lisa's alarm go off?",
      options: ["6:00", "6:30", "7:00", "7:30"],
      correctIndex: 1,
      explanation: "文章第一段明确提到'my alarm goes off at 6:30 in the morning'。",
    },
    {
      question: "How does Lisa get to work?",
      options: ["By car", "By bus", "By subway", "By bike"],
      correctIndex: 2,
      explanation: "文章提到'I walk to the subway station. The commute takes about 30 minutes.'，所以是坐地铁。",
    },
    {
      question: "What does Lisa usually do after dinner?",
      options: ["Go for a walk", "Watch TV or call family", "Read a book", "Clean the apartment"],
      correctIndex: 1,
      explanation: "文章最后一段提到'After dinner, I like to relax by watching TV or calling my family.'",
    },
  ],
  speakingExamples: [
...
MOCK_ENGLISH_ANSWERS[2] = {
  ...
  readingQuiz: [
    {
      question: "Which Chinese cuisine is known for being spicy and numbing?",
      options: ["Cantonese", "Sichuan", "Shandong", "Huaiyang"],
      correctIndex: 1,
      explanation: "文章提到'Sichuan food is famous for being spicy and numbing.'",
    },
    {
      question: "What food is eaten during Spring Festival according to the article?",
      options: ["Mooncakes", "Dumplings", "Zongzi", "Noodles"],
      correctIndex: 1,
      explanation: "文章提到'dumplings are eaten during Spring Festival'。",
    },
    {
      question: "What does the article say about Chinese restaurants around the world?",
      options: ["They all serve authentic food", "They often adapt menus to local tastes", "They only serve Cantonese food", "They are all very expensive"],
      correctIndex: 1,
      explanation: "文章提到'Chinese restaurants around the world often adapt their menus to local tastes.'",
    },
  ],
  speakingExamples: [
...
MOCK_ENGLISH_ANSWERS[3] = {
  ...
  readingQuiz: [
    {
      question: "According to the article, what should you consider when looking for a job?",
      options: ["Only salary", "Only interests", "Both interests and skills, plus salary and balance", "Only the company name"],
      correctIndex: 2,
      explanation: "文章提到'it is important to consider both your interests and your skills... you also need to think about salary and work-life balance.'",
    },
    {
      question: "What should you do to prepare for a job interview?",
      options: ["Wear casual clothes", "Research the company and practice questions", "Arrive late to seem busy", "Don't ask any questions"],
      correctIndex: 1,
      explanation: "文章提到'Prepare by researching the company and practicing common questions. Dress professionally and arrive early.'",
    },
    {
      question: "What is the main idea of the last paragraph?",
      options: ["You should quit your job if it's hard", "Learning continues even after you get the job", "All workplaces are the same", "You don't need feedback"],
      correctIndex: 1,
      explanation: "最后一段的主题是'Once you get the job, the learning continues.'，强调入职后仍需学习。",
    },
  ],
  speakingExamples: [
